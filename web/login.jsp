...
<body>
<div class="row lyear-wrapper" style="background-image: url(${pageContext.request.contextPath}/assets/images/login-bg-3.jpg); background-size: cover;">
    <div class="lyear-login">
        <div class="login-center">
            <div class="login-header text-center">
                <a href="index.html"> <img alt="light year admin" src="${pageContext.request.contextPath}/assets/images/logo-sidebar.png"> </a>
            </div>
            <form action="#!" method="post">
                ...
                <div class="form-group has-feedback feedback-left row">
                    ...
                    <div class="col-xs-5">
                        <img src="${pageContext.request.contextPath}/assets/images/captcha.png" class="pull-right" id="captcha" style="cursor: pointer;" onclick="this.src=this.src+'?d='+Math.random();" title="点击刷新" alt="captcha">
                    </div>
                </div>
